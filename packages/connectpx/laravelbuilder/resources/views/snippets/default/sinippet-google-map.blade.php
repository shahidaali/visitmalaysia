<div data-type="component-googlemap" data-preview="{{ laravelbuilder_default_preview('googlemap.png') }}" data-keditor-title="Google Map" data-keditor-categories="Gmap">
