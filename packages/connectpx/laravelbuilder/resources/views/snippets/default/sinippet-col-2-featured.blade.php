<div data-type="container" data-preview="{{ laravelbuilder_default_preview('featured_article.png') }}" data-keditor-title="Featured Article" data-keditor-categories="Text;Heading;Photo">
    <div class="row">
        <div class="col-sm-6" data-type="container-content">
            <div data-type="component-photo">
                <div class="photo-panel" style="text-align: center;">
                    <img src="{{ laravelbuilder_default_image('sydney_australia_squared.jpg') }}" width="100%" height="" style="display: inline-block; height: 334px; width: 334px;" class="img-responsive img-circle">
                </div>
            </div>
        </div>
        <div class="col-sm-6" data-type="container-content">
